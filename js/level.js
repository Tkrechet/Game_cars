...
const LEVELS_CONFIG = {
    ...
    3: {
        name: 'Уровень 3',
        description: 'Доберитесь до финиша за целевое время, ведите свою машину курсором. Если придете раньше или позже - проиграете! Выходить за рамки дороги нельзя :)',
        roundsCount: { min: 3, max: 5 },
        difficulty: 'hard',
        timeLimit: 180,
        images: {
